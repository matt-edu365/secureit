...
$dashboard = secureit_dashboard_stats($tenants, 'tenant_summary');
ob_start();
?>
<section class="section">
  <div class="metrics-grid">
    <article class="card metric-card"><div class="muted">Tenants</div><div class="metric-value"><?php echo htmlspecialchars((string) $dashboard['tenantCount']); ?></div><div class="metric-note">Total tenants configured in this SecureIT prototype.</div></article>
  ...
  <?php else: ?>
    <div class="tenant-grid">
      ...
      <article class="card tenant-card" data-tenant-card data-tenant-search="placeholder tenant finance school coming soon">
        <div class="tenant-head">
          <div>
            <h3 style="margin-bottom:6px;">Placeholder tenant 02</h3>
            <div class="tenant-meta">
        ...
        <div class="inline-links">
          <a class="textlink" href="onboard.php">Start onboarding</a>
        </div>
      </article>
      ...
      <article class="card tenant-card" data-tenant-card data-tenant-search="placeholder tenant legal hospitality coming soon">
        <div class="tenant-head">
          <div>
            <h3 style="margin-bottom:6px;">Placeholder tenant 03</h3>
            <div class="tenant-meta">
...
secureit_render_layout(
    'SecureIT Admin Dashboard',
    'SecureIT Administrator Portal',
    'Multi-Tenant Operational view for ICT365 administrators',
    $content,
    [
        'eyebrow' => '',
        'backHref' => null,
