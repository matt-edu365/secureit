...
$examplePath = __DIR__ . '/../config/tenants.example.json';
$adminConfigPath = __DIR__ . '/../config/admin-config.json';
...
<body>
  ...
  <div class="card">
    ...
    <h2>Reference</h2>
    <p class="muted">Current example tenant registry structure:</p>
